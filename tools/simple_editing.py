...
def main():
    ...
    results={'original_unchanged':True,'original_sha256':before,'file':TARGET.name,'pages':stats,'all_365_columns_and_77_references_preserved':True,'one_editable_shape_per_table':True,'connectors_preserved':True}
